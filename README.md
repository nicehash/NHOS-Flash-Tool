...
- __SSH key:__ SSH public key for user authentication.__**Optional*__
 ...
 - Download installer for Windows([32bit](https://github.com/nicehash/NHOS-Flash-Tool/releases/download/1.0.6/NHOS-Flash-Tool-1.0.6-win32.exe),[64bit](https://github.com/nicehash/NHOS-Flash-Tool/releases/download/1.0.6/NHOS-Flash-Tool-1.0.6-win64.exe))
 - Download installer for Linux([DEB](https://github.com/nicehash/NHOS-Flash-Tool/releases/download/1.0.6/NHOS-Flash-Tool-1.0.6.deb),[RPM](https://github.com/nicehash/NHOS-Flash-Tool/releases/download/1.0.6/NHOS-Flash-Tool-1.0.6.rpm))
 - Download installer for [MacOS (DMG)](https://github.com/nicehash/NHOS-Flash-Tool/releases/download/1.0.6/NHOS-Flash-Tool-1.0.6.dmg)
